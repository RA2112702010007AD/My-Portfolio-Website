              ...
              <div className="lg:col-span-7 bg-slate-50/50 border border-slate-100 p-6 md:p-8 rounded-3xl" id="contact-form-wrapper">
                <form onSubmit={handleContactSubmit} className="space-y-4" id="direct-contact-form">
                  ...
                  <button
                    ...
                    className="w-full bg-indigo-600 hover:bg-slate-900 text-white font-bold py-3 px-6 rounded-xl text-sm transition-colors cursor-pointer flex items-center justify-center gap-2 shadow-md shadow-indigo-600/10"
